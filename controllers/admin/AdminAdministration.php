...
class AdminAdministrationController extends ModuleAdminController {
    var $modules = null;
    ...
    public function __construct() {                
        ...
        ******************/
        $this->modules = array (
	        array('name' => 'IncomeTimeInterval', 'displayName' => $this->l('Income per time interval'), 'active' => true),
	        array('name' => 'IncomeProductCat', 'displayName' => $this->l('Income per product categories'), 'active' => true),
	        array('name' => 'IncomeSource', 'displayName' => $this->l('Income per visitor source'), 'active' => true),
	        array('name' => 'IncomeCartValue', 'displayName' => $this->l('Cart value'), 'active' => true),
	        array('name' => 'ExpenseTimeInterval', 'displayName' => $this->l('Expenses per time interval'), 'active' => true),
	        array('name' => 'Profit', 'displayName' => $this->l('Profit'), 'active' => true),
	        array('name' => 'Margin', 'displayName' => $this->l('Margin pro order'), 'active' => true),
	    );	    
	...
	public function initContent()
	{
		...
		$this->toolbar_title = $this->l('Controlling - Administration tables');
    ...
    {
        $tpl_path = _MODULE_DIR_.$this->module->name.'/views/templates/admin/'.$tpl_name;
